...
const Navbar = () => {
  ...
  return (
    <nav
      className={`gruppo fixed flex-no-wrap top-0 right-0 left-0 z-100  text-white z-50 ${
        isHome ? "bg-[#0077B6] bg-opacity-80" : "bg-[#0077B6] bg-opacity-80"
      }`}
    >
      <div className="flex justify-between max-w-7xl mx-auto px-4 lg:py-3 md:py-3 sm:py:1 py-1">
        <div className="flex justify-center items-center">
          <img
            onClick={() => {
              navigate("/");
            }}
            className="h-6 md:h-9 md:w-14 cursor-pointer"
            src="/sa-logo.png"
            alt=""
          />
        </div>
