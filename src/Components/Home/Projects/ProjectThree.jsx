      ...
      <div>
        <div className="mb-3">
          ...
          <p className="text-justify text-[12px] md:text-[18px]">
            A responsive and user-friendly platform providing detailed
            information on tourist destinations across Southeast Asia, including
            Bangladesh, Thailand, Indonesia, Malaysia, and Vietnam. Features
            include emergency contact information, healthcare facilities, safety
            tips, and the ability to add and update tourist spots. Ensures a
        ...
        <div className="relative pb-16 text-[11px] md:text-[17px]">
          <ul className="text-gray-500 list-disc">
            <li>Intuitive Interface & Responsive Design</li>
            <li>
          ...
          <div className="mt-10 flex flex-col md:flex-row justify-between items-center gap-5">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-5">
              <a href="https://github.com/sharearahammed/tourism-management-client.git">
                <button className="flex justify-center items-center gap-3 bg-gradient-to-r from-[#0077B6] to-blue-500 hover:from-blue-950 hover:to-blue-800 text-white px-5 py-3 rounded-lg">
                  Client Site Code <LuFileCode className="text-2xl" />
                </button>
              </a>
              <a href="https://github.com/sharearahammed/tourism-management-server">
                <button className="flex justify-center items-center gap-3 bg-gradient-to-r from-[#0077B6] to-blue-500 hover:from-blue-950 hover:to-blue-800 text-white px-5 py-3 rounded-lg">
                  Server Site Code <LuFileCode className="text-2xl" />
                </button>
              </a>
            </div>
          </div>
